...
<html lang="en">
<head>
    <title>Code coverage report for youstream/youstream.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">youstream/youstream.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90.2% <small>(46 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">93.88% <small>(46 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">youstream/</a> &#187; youstream.js</div>
</div>
<div class="body">
...
&nbsp;
  // Prepare args.
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options === 'undefined') {
<span class="cstat-no" title="statement not covered" >    options = [];</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof auth_path === 'undefined') {
    auth_path = './auth.json';
  }
&nbsp;
  // Normalize video URL.
  if (url.parse(video_url).protocol === null) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (video_url.match('\A\/[^\/]+')) { <span class="cstat-no" title="statement not covered" >video_url = 'http://' + video_url; </span>}
    <span class="missing-if-branch" title="if path not taken" >I</span>if (video_url.match('\A\/[^\/]+')) { <span class="cstat-no" title="statement not covered" >video_url = 'http:/'  + video_url; </span>}
...
<span class="cstat-no" title="statement not covered" >          stream.emit('failed to read auth.json');</span>
        }
        else {
          // Prepare options.
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof obj.videopassword !== 'undefined') {
<span class="cstat-no" title="statement not covered" >    info = info.concat(['--video-password', obj.videopassword]);</span>
  }
&nbsp;
  return info;
};
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Jun 07 2014 01:54:56 GMT+0900 (JST)</div>
</div>
